...
*Dream Marketplace* — это онлайн-платформа для фиксации, визуализации и обмена сновидениями. Пользователи создают записи своих снов в текстовом формате, после чего могут превратить их в мультимедийный контент (изображение, видео) с помощью встроенного AI-сервиса *GenAPI*. 

*GenAPI* анализирует текст сна и генерирует изображения или видео, учитывая сюжет, атмосферу и символику, а также может подстраиваться под стиль конкретного пользователя.
...
*FR14*. Система должна предоставлять пользователю возможность пополнять баланс.
...
*FR17*. Система должна обеспечивать пользователю возможность скачивать купленную визуализацию в доступном формате.  
