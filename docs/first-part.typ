...
*FR12*. Система должна обеспечивать пользователю возможность покупать лот через платёжную систему и закреплять право на владение за покупателем при успешной оплате.

*FR13*. Система должна предоставлять пользователю возможность оставлять комментарии и ставить рейтинг лоту.  

*FR14*. Система должна предоставлять пользователю возможность пополнения внутреннего баланса через эмуляцию платёжной системы, включая выбор суммы, подтверждение операции и зачисление средств.

*FR15*. Система должна предоставлять пользователю возможность просматривать свой баланс и покупки. 

*FR16*. Система должна предоставлять пользователю возможность запросить повторную генерацию визуализации (получить альтернативный вариант). 

*FR17*. Система должна обеспечивать пользователю возможность скачивания купленной визуализации в поддерживаемых форматах, включая графические (JPEG) и видео (MP4) файлы.

#v(0.25cm)

*Требования администратора:*

*FR18*. Система должна предоставлять администратору возможность просматривать и модерировать лоты (блокировать неприемлемые лоты).  
